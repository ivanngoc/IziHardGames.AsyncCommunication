...
namespace IziHardGames.Async.ValueTasks
{
    /// <summary>
    ...
    /// Аналог c базой на <see cref="ValueTask{TResult}"/>
    /// </summary>

    [Guid("5994bba1-cc3a-4b7f-a2c6-dcdbabefa86e")]
    public sealed class AsyncSignaler : IValueTaskSource<bool>, IDisposable, IPoolable<AsyncSignaler>, IValueTaskBased, IAwaitComntrol
    {
        ...
        public IPool<AsyncSignaler> Pool { get; private set; } = null!;
        ...
        private async ValueTask<bool> True()
        {
        ...
        public static AsyncSignaler Rent(IPool<AsyncSignaler> pool)
        {
            var rent = pool.Rent();
            rent.ReturnTo(pool);
            return rent;
        ...
        public void ReturnTo(IPoolReturn<AsyncSignaler> pool)
        {
            Pool = pool as IPool<AsyncSignaler> ?? throw new NullReferenceException();
        }
#if DEBUG
